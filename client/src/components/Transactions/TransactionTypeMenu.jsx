...
const TransactionTypeMenu = ({ onSelectType, onClose }) => {
    return (
        <div className="fixed inset-0 z-50 flex items-end justify-center">
            ...
            <div className="relative bg-transparent w-full max-w-md p-6 pb-10 z-10">
                ...
                <div className="flex justify-center -mt-2">
                    <button
                        onClick={onClose}
                        className="w-16 h-16 rounded-full bg-white shadow-lg flex items-center justify-center hover:bg-gray-100 transition-transform duration-300 rotate-0 hover:rotate-90"
                    >
