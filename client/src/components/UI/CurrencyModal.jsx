    ...
    return (
        <div className="fixed inset-0 z-60">
            ...
            <div className="fixed bottom-0 left-0 right-0 md:bottom-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2">
                <div className="bg-white rounded-t-3xl md:rounded-2xl w-full max-w-md mx-auto flex flex-col">
                    <div className="flex justify-between items-center p-4 border-b">
                        <h2 className="text-xl font-bold">Выберите основную валюту</h2>
                    ...
                    <div className="p-4 space-y-2">
                        {currencies.map((currency) => (
                            ...
                            >
                                ...
                                {selected === currency.code && (
                                    <span className="text-blue-500 text-sm font-medium">Выбрано</span>
                                )}
                            </label>
                        ))}
                    </div>
                    <div className="p-4 border-t">
                        <button
                            ...
                            className="w-full bg-blue-500 text-white py-3 rounded-xl font-medium hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition"
                        >
                            Сохранить
                        </button>
                    </div>
