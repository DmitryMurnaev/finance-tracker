        ...
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-6 text-white mb-6 shadow-lg">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
                <div className="flex items-center min-w-0">
                    ...
                    <h2 className="text-lg font-semibold whitespace-nowrap">Текущий баланс</h2>
                </div>
            ...
            <div className="text-center">
                <div className="text-4xl sm:text-5xl font-bold mb-2 break-words">
                    {formatCurrency(balance)}
                </div>
                <div className="text-blue-100 text-sm sm:text-base break-words">
