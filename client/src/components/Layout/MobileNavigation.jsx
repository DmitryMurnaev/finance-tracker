...
const MobileNavigation = ({ activeTab, setActiveTab, onAddClick, isMenuOpen = false}) => (
    <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 px-4 pt-3 pb-[max(0.75rem,env(safe-area-inset-bottom,0.75rem))] grid grid-cols-3 z-20">
