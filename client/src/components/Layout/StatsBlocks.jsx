    ...
    return (
        <div className="grid grid-cols-1 min-[370px]:grid-cols-2 gap-3 sm:gap-4 mb-6">
            <div className="bg-white p-3 sm:p-5 rounded-xl shadow border border-gray-100 overflow-hidden">
                <div className="text-green-500 font-bold text-base sm:text-lg md:text-2xl truncate">
            ...
            <div className="bg-white p-3 sm:p-5 rounded-xl shadow border border-gray-100 overflow-hidden">
                <div className="text-red-500 font-bold text-base sm:text-lg md:text-2xl truncate">
